...
\begin{enumerate}
  \item
    ...
    \item
      ...
      know that if a vector $\gamma$ is not in $W_1$, then for a vector $\alpha$ in
      $W_1$, $c\gamma + \alpha$ must not be in $W_1$ for at least some values of $c$
      and $\alpha$; likewise for $W_2$. This contradicts the notion that $W_1 \cup
      W_2$ is a subspace, as it contains $X_1$ and $X_2$ together.
